    ...
    <div>
      <div className="py-24 bg-gradient-to-b from-orange-50 to-white">
        <div className="container mx-auto px-6 max-w-4xl text-center">
          <h2 className="text-6xl font-bold mb-6 text-gray-800">Everest Independence Trek</h2>
          ...
          <p className="text-3xl font-light italic text-gray-700 mb-12 leading-relaxed">
            "Celebrate India's spirit of freedom at the top of the world. Join our exclusive Everest Base Camp trek on the auspicious occasion of Independence Day."
          </p>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg mb-16">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="text-left">
                <h3 className="text-2xl font-bold text-gray-800 mb-6">Registration</h3>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-semibold text-gray-800">Limited Spots</p>
                  ...
                  <button className="mt-4 w-full bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 text-white py-3 px-6 rounded-lg font-bold hover:from-orange-600 hover:to-orange-800 transition duration-300">
                    Register Now
                  </button>
                </div>
              </div>
