      ...
      <div className="py-24 px-4 sm:px-8 md:px-12 lg:px-16">
        <div className="container mx-auto px-6 w-full text-center">
          ...
          <p className="text-lg text-gray-300 mb-16 max-w-2xl mx-auto">
            "For over two decades, FLYEAST has been guiding
          ...
          <div className="relative mb-16">
            ...
            <div className="relative flex justify-center">
              <div className="bg-[#F2385A] text-white px-4 py-2 rounded-full">
            ...
            <div className="bg-zinc-800 p-8 rounded-lg shadow-sm">
              ...
              <div className="flex flex-col gap-6">
                {[{
                  ...
                  title: "Excellence",
                  description: "We never compromise on quality, expertise, or safety...",
                },
                {
                  icon: <Heart className="w-6 h-6 text-[#F2385A]" />,
                  title: "Sustainability",
                  description: "We practice and promote responsible tourism...",
                },
                {
                  icon: <Clock className="w-6 h-6 text-[#F2385A]" />,
                  title: "Mindfulness",
                  description: "We believe in being present and fully experiencing each moment in the mountains...",
                }].map((value, idx) => (
                  <div key={idx} className="flex items-start gap-4">
                    ...
                    <div className="text-left">
                      <p className="font-medium text-white mb-1">{value.title}</p>
