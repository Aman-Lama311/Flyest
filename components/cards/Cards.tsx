...
const Cards = () => {
  ...
  const slides = [
    {
      image:
        "https://images.pexels.com/photos/19210728/pexels-photo-19210728/free-photo-of-gorsa-bridge-en-norvege-vue-de-drone-chute-d-eau-montagne-pont.jpeg?auto=compress&cs=tinysrgb&w=600",
    ...
    {
      image:
        "https://images.pexels.com/photos/8645575/pexels-photo-8645575.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    ...
    {
      image:
        "https://images.pexels.com/photos/30858644/pexels-photo-30858644/free-photo-of-serene-pathway-through-a-misty-forest.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    ...
    {
      image:
        "https://images.pexels.com/photos/29828238/pexels-photo-29828238/free-photo-of-scenic-road-through-mixnitz-forest-austria.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
  ...
  const navigate = (direction: "next" | "prev") => {
    ...
    const currentSlideEl = document.querySelector(
      `.slide[data-index="${currentSlideIndex}"]`
    );
    const nextSlideEl = document.querySelector(
      `.slide[data-index="${nextSlideIndex}"]`
    );
  ...
  const createStyledText = (text: string, index: number, rowIndex: number) => {
    const slide = slides[index];
    let textContent = text;

    // Check for emphasis elements
    if (slide.emphasis[rowIndex][0]) {
      const wordIndex = slide.emphasis[rowIndex][1] as number;
    ...
    if (slide.strong[rowIndex][0]) {
      const wordIndex = slide.strong[rowIndex][1] as number;
  ...
  return (
    <div
      className="h-[90vh] w-full bg-[#faf3f3] font-['poppins'] overflow-hidden relative object-cover"
            ...
            <div className="slide-caption absolute left-0 top-1/3 transform -translate-y-1/3 px-18 w-full z-20">
              ...
              <h2 className="text-5xl md:text-6xl text-black uppercase font-light">
                {slide.headline.map((text, rowIndex) => (
                  <div
                    className="text-row overflow-hidden text-black mb-2 h-16 transform transition-transform"
                    key={rowIndex}
                  >
              ...
              <h2 className='font-bold font-["poppins"] text-sm text-[#FF4E58] mt-10'>
                CHOOSE HERE
              </h2>
