            ...
            <div className="p-6 flex flex-col flex-grow">
              <div className="flex justify-between items-start mb-3">
                ...
                <div style={{ backgroundColor: `${THEME_COLOR}15` }} className="flex items-center px-2 py-1 rounded text-sm font-medium">
                  <Star size={14} style={{ color: THEME_COLOR }} className="mr-1" />
              ...
              <div className="flex items-center text-sm mb-3">
                ...
                <Clock size={16} style={{ color: THEME_COLOR }} className="ml-4 mr-1" />
                <span>{item.duration}</span>
              </div>
              <p className="text-sm mb-4 flex-grow font-sans">
                {item.description}
              </p>
                ...
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-xl font-bold">{formatPrice(item.newPrice)}</span>
                    </div>
                  </div>
